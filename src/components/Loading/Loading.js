...
const Loading = ({ firstVisit }) => {
	...
	const timing = {
		background: { enter: 0, exit: 300 },
		transition1: { enter: 200, exit: 200 },
		transition2: { enter: 200, exit: 200 },
		transition3: { enter: 200, exit: 200 },
		transition4: { enter: 200, exit: 200 },
		transition5: { enter: 200, exit: 200 },
	...
	const onEntered = {
		background: () => {
			setTransitions({ ...transitions, transition1: true })
		},
		transition1: () => {
			setTransitions({ ...transitions, transition1: false, transition2: true })
		},
		transition2: () => {
			setTransitions({ ...transitions, transition2: false, transition3: true })
		},
		transition3: () => {
			setTransitions({ ...transitions, transition3: false, transition4: true })
		},
		transition4: () => {
			setTransitions({ ...transitions, transition4: false, transition5: true })
		},
		transition5: () => {
			setTransitions({ ...transitions, transition5: false, transition6: true })
		},
		transition6: () => {
			setTransitions({ ...transitions, transition6: false, transition7: true })
		},
		transition7: () => {
			setTransitions({ ...transitions, transition7: false, transition8: true })
		},
		transition8: () => {
	...
	const onExited = {
		...
		transition9: () => {
			setTransitions({ ...transitions, background: false })
		}
	}
	const BLMimages = [
